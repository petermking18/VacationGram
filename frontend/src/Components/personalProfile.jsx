...
export class PersonalProfile extends React.Component {
    ...
    async onNewComment() {
        ...
        var commentReturnId = this.state.nextCommentId;
        let date = new Date();
        let mydate = months[date.getMonth()] + " " + date.getDate() + ", " + date.getFullYear();
        let mycomment = new Comment(
            commentReturnId, this.state.modalPost.id, this.state.user_id, this.state.username,
                    ...
                    <div className="bg-white">
                        ...
                        <ul className="nav nav-tabs tabs-alt justify-content-center">
                            <li className="nav-item">
                                <a className="nav-link py-4 active"><img src={feedIcon} id="galleryIcon" /></a>
                            </li>
                            <li className="nav-item">
                                <a onClick={this.goSavedPage} className="nav-link py-4"><img src={savedIcon} id="bookMarkIcon" /></a>
