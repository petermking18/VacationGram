        ...
        return (
            <>
                ...
                {this.state.hasSearched &&
                    <Feed posts={this.state.results} openPost={this.postModalOpen} editPost={this.editPostOpen} openProfile={this.openOtherProfile} likePost={this.onClickFeedLikeButton} savePost={this.onClickSaveButton} postIsDeletable={this.postIsDeletable} deletePost={this.deletePost} />
                }
